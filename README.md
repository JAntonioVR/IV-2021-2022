...
* Se ha hecho uso de [**Circle CI**](https://circleci.com/) como sistema de CI que ejecuta en paralelo los tests para las distintas versiones de Python, empleando las imágenes subidas a DockerHub para cada versión, a excepción de la versión por defecto.
...
Por tanto, cada vez que se hace un push a este repositorio se ejecutan los test un total de seis veces con seis contenedores base distintos. Pudiendo estar alerta y acorralar rápidamente cualquier fallo en alguna de las versiones.
